...
def look_up_in_domain(major_name):
    look_up_dict = {"khoa học máy tính": ['khoa học máy tính','khmt', 'KHMT', 'khoa hoc may tinh', 'Khoa hoc may tinh'],
                    "kỹ thuật điện": ["kĩ thuật điện","kỹ thuật điện",'ktđ', 'ktd', 'ky thuat dien', 'KTĐ', 'KTD'],
                    "kỹ thuật hóa học": ["kĩ thuật hóa học","kỹ thuật hóa học",'kthh', 'KTHH', 'ky thuat hoa hoc', 'Ky thuat hoa hoc'],
                    "kỹ thuật hàng không": ["kĩ thuật hàng không","kỹ thuật hàng không",'kthk', 'KTHK', 'ky thuat hang khong', 'Ky thuat hang khong'],
                    ...
                    "kỹ thuật điện tử viễn thông": ["kĩ thuật điện tử viễn thông","kỹ thuật điện tử viễn thông",'điện tử viễn thông', 'ĐTVT', 'đtvt', 'ky thuat dien tu vien thong', 'DTVT', 'dtvt'],
                    "kỹ thuật cơ điện tử": ["kĩ thuật cơ điện tử","kỹ thuật cơ điện tử",'ky thuat co dien tu', 'co dien tu', 'cơ điện tử', 'cđt', 'cdt', 'CĐT', 'CDT'],
                    "kỹ thuật điều khiển và tự động hóa": ["kĩ thuật điều kiển và tự động hóa","tdh","tđh","TĐH","TDH","kỹ thuật điều khiển và tự động hóa",'ky thuat dieu khien va tu dong hoa', 'điều khiển tự động hóa', 'đktđh', 'ĐKTĐH', 'dktdh',
